 ...
 */
class AuIt_Editor_Block_Adminhtml_Styles extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
    ...
    public function __construct()
    {
        ...
        $this->_addAfter = true;
        $this->_addButtonLabel = Mage::helper('adminhtml')->__('Add new style');
        parent::__construct();
 	}
    protected function _renderCellTemplate($columnName)
    {
    	...
    	}else if ($columnName == 'style'||$columnName == 'description')
        {
