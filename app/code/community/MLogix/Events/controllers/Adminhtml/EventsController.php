...
class MLogix_Events_Adminhtml_EventsController extends Mage_Adminhtml_Controller_action
{
	...
	public function categoriesJsonAction() {
    	$treeBlock = $this->getLayout()->createBlock('events/adminhtml_tree');
	...
	public function moveAction() {
        ...
        $category  = Mage::getModel('events/events')->load($nodeId);
		...
		if ($data = $this->getRequest()->getPost()) {
			...
			if(isset($_FILES['filename']['name']) && $_FILES['filename']['name'] != '') {
				try {	
					...
					if($itemId)
					{
						$temporaryModel = Mage::getModel('events/events')->load($itemId);
