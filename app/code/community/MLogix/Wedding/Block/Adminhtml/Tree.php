 ...
 */
?><?php
class MLogix_Wedding_Block_Adminhtml_Tree extends Mage_Adminhtml_Block_Template
{
	public function __construct()
	{  	
		$this->_controller = 'adminhtml_wedding';
		$this->_blockGroup = 'wedding';
		$this->_headerText = Mage::helper('wedding')->__('Categories');
	...
	protected function _prepareLayout()
	{
	    ...
	    $this->setChild('add_sub_button',
	        $this->getLayout()->createBlock('adminhtml/widget_button')
	            ->setData(array(
	                'label'     => Mage::helper('wedding')->__('Add Item'),
	    ...
	    $this->setChild('add_root_button',
	        $this->getLayout()->createBlock('adminhtml/widget_button')
	            ->setData(array(
	                'label'     => Mage::helper('wedding')->__('Add Root Category'),
	...
	{
		//$x = Mage::getModel('wedding/wedding')->load(1);
		//$x = $x->toArray();

		return 'Wedding Categories';
	}
	...
	{
		$cats = Mage::getModel('wedding/wedding')->getCategories($node);
